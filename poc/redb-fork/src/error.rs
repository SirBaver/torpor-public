...
use crate::compat::sync::PoisonError;
...
pub enum StorageError {
    ...
    PreviousIo,
    DatabaseClosed,
    LockPoisoned(&'static core::panic::Location<'static>),
}

impl<T> From<PoisonError<T>> for StorageError {
    fn from(_: PoisonError<T>) -> StorageError {
        StorageError::LockPoisoned(core::panic::Location::caller())
    }
}
...
pub enum TableError {
    ...
    TableAlreadyOpen(String, &'static core::panic::Location<'static>),
...
impl<T> From<PoisonError<T>> for Error {
    fn from(_: PoisonError<T>) -> Error {
        Error::LockPoisoned(core::panic::Location::caller())
    }
}
