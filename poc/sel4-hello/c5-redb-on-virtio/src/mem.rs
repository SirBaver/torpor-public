// Utilitaires mémoire pour C.5 — copie exacte de c4/src/mem.rs
// (map_ram_pages, map_device_pages_contiguous, trim_untyped)

use sel4::{CapRights, ObjectBlueprint, ObjectBlueprintArch, VmAttributes, init_thread};

pub const PAGE_SIZE: usize = 4096;

/// Alloue N SmallPages RAM depuis le plus grand Untyped non-device.
/// Mappe à [va_base .. va_base + N×4KB). Retourne paddr du premier frame.
...
/// trimme jusqu'à target_paddr, retypes N SmallPages, mappe à va_base.
