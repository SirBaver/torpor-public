...
- [ ] **Publication différée** *(décision utilisateur 2026-06-10 : « pas prêt à publier en vrai »)*. Conséquence : les triggers en aval (position seL4, article) restent dormants — conforme à leur design. **Reste actif et indépendant : la sauvegarde** — un remote *privé* (ou copie hors-machine) pour les 3 dépôts, sans aucune exposition. Risque actuel inchangé : tout vit sur un seul NVMe.
